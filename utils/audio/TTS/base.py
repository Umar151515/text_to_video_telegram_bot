...
async def text_to_speech(text: str, speaker:str = None, selected_tool:str = None, output_path:str = None) -> numpy.ndarray:
    ...
    if generation_method == "coqui":
        return await text_to_speech_coqui(text, speaker, output_path)
    else:
